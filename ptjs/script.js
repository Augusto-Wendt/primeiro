...
//Olá Mundo!
function helloWolrd() {
    document.getElementById("mostrar").innerHTML = "Hello World! Seja bem vindo!";
    console.log(`Hello Wolrd! Seja bem vindo!"`);
    alert(`Hello Wolrd! Seja bem vindo!`);
  }
  ...
  function nomeDigitado() {
    document.getElementById("mostrar").innerHTML = "Seu nome é " + nome.value;
  }
  ...
  function média() {
    ...
    if (idade < maioridade) {
      ...
      document.getElementById("mostrar").innerHTML =
        "Faltam " + tempo + " ano(s) para você atingir a média";
    } else {
      document.getElementById("mostrar").innerHTML =
  ...
  function altura() {
    ...
    document.getElementById("mostrar").innerHTML =
      "A média das estaturas é: " + Math.round(media_altura) + " metros";
  }
  ...
  function dias() {
    ...
    document.getElementById("mostrar").innerHTML =
      "Já passar mais de " + dias + " dias desde 01/01/0001";
  }
  ...
  function media() {
    ...
    if (m1 < media) {
      ...
      document.getElementById("mostrar").innerHTML =
        ...
        Math.round(media) +
        "<br>" +
        "A nota 2 é menor que a média final";
    } else if (m3 < media) {
      document.getElementById("mostrar").innerHTML =
        "A nota final é: " +
        Math.round(media) + //akls
        "<br>" +
        "A nota 3 é menor que a média final";
    }
  }
  ...
  function idade() {
    ...
    if (idade < 18) {
      document.getElementById("mostrar").innerHTML = "Você é de menor";
    } else {
      //kajs
      document.getElementById("mostrar").innerHTML = "Você é de maior";
    }
  }
  ...
  function multiplo() {
    ...
    if (numero % 5 == 0) {
      document.getElementById("mostrar").innerHTML =
        "Este número " + numero + " é múltiplo de 5";
    } else {
      document.getElementById("mostrar").innerHTML =
        "Este número " + numero + " não é múltiplo de 5";
    }
  }
  ...
  function num() {
    ...
    if (num_digitado >= 0 && num_digitado <= 6) {
      ...
      document.getElementById("mostrar").innerHTML =
        "O número digitado tem que estar entre 0 e 6";
    }
  }
  ...
  function inteiro() {
    ...
    if (num == 0) {
      document.getElementById("mostrar").innerHTML = "Igual a zero";
    } else if (num < 0) {
      document.getElementById("mostrar").innerHTML = " Negativo";
    } else {
      document.getElementById("mostrar").innerHTML = "Positivo";
    }
  }
  ...
  function escolha() {
    ...
    switch (opcoes) {
      case "1":
        alert("Voce é maravilhoso(a)!");
        break;
      case "2":
        alert("Voce é péssimo!");
        break;
      case "3":
        alert("Valeu, falou!");
        break;
  ...
  function consistencia() {
    ...
    do {
      idade = prompt("Diga sua idade (valores aceitos de 5 a 150): ");
  ...
  function mediaDez() {
    ...
    //oeut
    media = soma / 10;
    alert("A média destes números é: " + media);
  }
  ...
  function vetor() {
    ...
    document.getElementById("mostrar").innerHTML = "Vetor em sua ordem original: ";
  ...
  function posicao() {
    ...
    if (achou == false) {
      document.getElementById("mostrar").innerHTML = "O número escolhido não está no vetor";
    }
  } //haj
  
  //Tabela de dados
  function tabela() {
    let nome = ["Augusto", "Andre", "Gustavo O.", "Gustavo M.", "Lucas"];
  ...
  function vetores() {
    ...
    mostrarResultado("Vetor anteior a ordenação:", vet);
  
    ordena(vet); //ajkhasj
  
    mostrarResultado("Vetor depois da ordenação:", vet);
  }
